...
if ($_SERVER['REQUEST_METHOD'] == 'POST' && isset($_POST['add_lowongan'])) {
    ...
    if (empty($posisi) || empty($tgl_buka) || empty($tgl_tutup)) {
        $error = "Field yang ditandai * harus diisi!";
    } else {
...
<head>
    ...
    <style>
        ...
        .btn-add { padding: 10px 20px; background: #667eea; color: white; text-decoration: none; border-radius: 5px; margin-bottom: 20px; display: inline-block; border: none; cursor: pointer; }
    ...
    <div class="dashboard-container">
        ...
        <main class="main-content">
            ...
            <div class="content">
                ...
                <button class="btn-add" onclick="document.getElementById('addModal').style.display='block'">+ Tambah Lowongan</button>
                ...
                <div class="table-container">
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            ?>
                            <tr>
                                <td colspan="6" style="text-align: center; color: #888; padding: 30px;">Belum ada lowongan</td>
                            </tr>
                            <?php endif; ?>
                        </tbody>
                    </table>
        ...
        <div class="modal-content">
            ...
            <form method="POST">
                ...
                <div class="form-group">
                    ...
                    <textarea name="persyaratan" placeholder="Masukkan persyaratan lowongan..."></textarea>
                </div>
                ...
                <div class="form-group">
                    ...
                    <input type="date" name="tgl_interview">
                </div>
                
                <div class="form-group">
                    <label>Tanggal TKD</label>
                    <input type="date" name="tgl_tkd">
                </div>
                
                <div class="form-group">
                    <label>Tanggal Pengumuman Hasil</label>
                    <input type="date" name="pengumuman_hasil">
                </div>
